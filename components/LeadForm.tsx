export default function LeadForm({
  ...
  theme?: 'dark' | 'light'; // kept for backwards compat, unused
}) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <a
        ...
        className="w-full max-w-sm flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-4 px-8 rounded-xl transition-all hover:scale-[1.02] shadow-xl shadow-green-900/20 text-base"
      >
      ...
      <p className="text-slate-500 text-xs">Sin compromiso. Le respondemos en menos de 5 minutos.</p>
    </div>
  );
}
